...
Slop.loop(({time,width,height})=>{
 ...
 ctx.fillStyle='#302a3d';ctx.textAlign='center';ctx.font='bold 28px system-ui';ctx.fillText(points+' bounces',width/2,height*.24);
