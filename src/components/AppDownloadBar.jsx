...
export default function AppDownloadBar(){return <section className="home-app-download" aria-label="Download the Slop app">
 <span className="home-app-icon" aria-hidden="true"><img src="/assets/mobile/app-icon.png?v=20260926" alt=""/></span>
 ...
 <div className="home-app-actions">
  <a href={appStoreUrl} target="_blank" rel="noopener noreferrer" aria-label="Download Slop on the App Store"><AppleMark/><span>App Store</span></a>
  <a href={googlePlayUrl} target="_blank" rel="noopener noreferrer" aria-label="Get Slop on Google Play"><AndroidMark/><span>Google Play</span></a>
 </div>
</section>}
